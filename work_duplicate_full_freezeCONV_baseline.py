...
def main(args, model=None):
    ...
    train_loader = DataLoader(train_data, batch_size=125, shuffle=True, drop_last=False)  #, num_workers=5)
    ...
    # >>>> freeze grad
    if model is None:
        model = DoubleBranchAlex(train_data.cls_count, pretrain_dir=pretrain_dir, freeze_features=True)
