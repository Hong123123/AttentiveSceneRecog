...
if __name__ == '__main__':
    ...
    atal = AttenDAlex(10, pretrain_dir=config.places_alex).cpu()
    matal = AttenDAlex(10, atten_type='multi', pretrain_dir=config.places_alex).cpu()
    ...
    print(atal(r, d).shape)
    print(matal(r,d).shape)
