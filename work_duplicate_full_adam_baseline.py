...
# python work.py --lr 3e-4 --l2 0.1 --log_root /home/hong/small_log_atten/nyudv2/freeze_baseline/debug --epochs 100000 --pretrain_dir /mnt/pub_workspace_2T/hong_data/AttentiveScenery/models/ckpt/alexnet_places365.pth.tar --save_inteval_epoch 1 --device cuda:2
